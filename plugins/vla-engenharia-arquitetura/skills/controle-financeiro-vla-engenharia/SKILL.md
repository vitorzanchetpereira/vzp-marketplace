...
Ler integralmente [references/procedimento.md](references/procedimento.md) antes de executar. É o POP de Controle e Conciliação Financeira (mesmo conteúdo do documento oficial `POP-*-Controle-Financeiro-R00.docx`).
